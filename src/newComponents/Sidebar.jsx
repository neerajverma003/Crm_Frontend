...
//       if (role === "employee") {
//         endpoint = `http://localhost:4000/employee/getEmployee/${userId}`;
//       } else if (role === "admin") {
//         endpoint = `http://localhost:4000/getAdmin/${userId}`;
...
//   // ✅ Updated Lead Management item with main URL
//   const allItems = [
...
//       children: [
//         { id: "2-1", label: "My Leads", url: "/addmylead" },
//       ],
//     },
...
//     { id: 5, label: "Leave Management", icon: <FiClock size={20} />, url: role === "admin" || role === "superadmin" ? "/leaves" : "/leave-apply", roles: ["admin", "employee", "superadmin"] },
...
//                     <div className="flex items-center justify-between rounded-lg px-4 py-3 text-gray-700 hover:bg-gray-100">
//                       <NavLink
//                         to={item.url || "#"}
//                         onClick={() => setIsOpen(false)} // ✅ close sidebar on mobile
//                         className={({ isActive }) =>
//                           isActive
//                             ? "flex items-center gap-3 flex-1 font-semibold text-black"
...
//       url: "/lead-management",
//       roles: ["admin", "employee", "superadmin"],
//       children: [{ id: "2-1", label: "My Leads", url: "/addmylead" }],
//     },
...
//       type: "dropdown",
//       url: "/user-management", // main page is all users
//       roles: ["admin", "superadmin"],
//       children: [
//         { id: "3-1", label: "Add Admin", url: "/add-admin" },
//         { id: "3-2", label: "Assign Company", url: "/assignCompany" },
//       ],
//     },
...
const Sidebar = () => {
  ...
  const allItems = [
    ...
    {
      id: 2,
      label: "Lead Dashboard", // 🟢 Renamed
      icon: <FiUsers size={20} />,
      type: "dropdown",
      url: "/lead-management",
      roles: ["admin", "employee", "superadmin"],
      children: [
        { id: "2-1", label: "Assign Lead", url: "/assignlead" }, // 🆕 New
        { id: "2-2", label: "My Leads", url: "/addmylead" }, // existing
        { id: "2-3", label: "Today's Leads", url: "/todaysleads" }, // 🆕 New
        { id: "2-4", label: "Follow-Up Leads", url: "/followupleads" }, // 🆕 New
      ],
    },
...

    {
      ...
      icon: <FiClock size={20} />,
      url:
        role === "admin" || role === "superadmin" ? "/leaves" : "/leave-apply",
      roles: ["admin", "employee", "superadmin"],
    },
